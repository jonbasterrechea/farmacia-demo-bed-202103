...
class AlmacenClientContractTest {
    ...
    @Test
    @DisplayName("solicitarReservaMedicamento cuando se hace una reserva de un medicamento con disponibilidad se recupera la información de la reserva generada en el almacen")
    void solicitarReservaMedicamento_reserva_almacen_OK() {
    ...
    @Test
    @DisplayName("solicitarReservaMedicamento cuando se hace una reserva de un medicamento sin disponibilidad devuelve BAD REQUEST")
    void solicitarReservaMedicamento_reserva_almacen_KO() {
