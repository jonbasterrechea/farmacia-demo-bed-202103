...
class PedidosAlmacenServiceTest {
    ...
    void realizarPedido_guarda_informacion_pedido() {
        ...
        PedidoAlmacen resultado = pedidosAlmacenService.realizarPedido(45L, 66).orElseThrow();
        ...
        assertAll("Se ha guardado correctamente la petición al almacen en bd",
                ...
                () -> assertEquals(95L, resultado.getIdReservaAlmacen()),
                () -> assertEquals(45, resultado.getIdMedicamento()),
                () -> assertEquals(66, resultado.getUnidadesPedidas()),
                () -> assertEquals(resultado, pedidosAlmacenRepository.findByIdReservaAlmacen(idReservaAlmacen)));
    ...
    void realizarPedido_si_no_realizado_correctamente_no_hace_nada() {
        long numPedidosAntes = pedidosAlmacenRepository.count();
